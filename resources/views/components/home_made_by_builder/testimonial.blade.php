            ...
            <div class="col-lg-8 col-md-8">
                <div class="user-slider owl-carousel owl-theme">
                    ...
                    <div class="single-opinion">
                        ...
                        <div class="testimonial-border">
                            <div class="testimonial-des">
                                <span class="description overlay-content overlay-content-max-h-150"><span class="builder-editable" builder-identity="15">{{ get_phrase('It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of use Lorem Ipsum.') }}</span>
                                    <div class="user-info d-flex">
                                        <div class="ellipsis-line-2">
...
<script>
    $('.testimonials-wrapper .user-slider').owlCarousel({
        ...
        margin: 10,
        nav: true,
        navText: ['<i class="fa-solid fa-chevron-left">', '<i class="fa-solid fa-chevron-right">'],
        dots: false,
        responsive: {
            0: {
                items: 1
