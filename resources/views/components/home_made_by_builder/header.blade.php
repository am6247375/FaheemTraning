        ...
        <div class="row flex-md-nowrap "
            ...
            <div class="col-auto">
                <div class="logo-image">
                    <a href="{{ route('home') }}">
                        <!-- لوجو داكن يظهر دائماً -->
                        <img src="{{ get_image(get_frontend_settings('dark_logo')) }}" alt="system logo"
                            class="img-fluid rounded header-dark-logo">

                        <!-- لوجو فاتح يظهر عند الحاجة -->
                        <img src="{{ get_image(get_frontend_settings('light_logo')) }}" alt="system logo"
                            class="img-fluid rounded header-light-logo d-none">
                    </a>
                </div>
            </div>
                        ...
                        <ul class="primary-menu main-menu-ul d-flex align-items-center w-100 drop-area">
                            ...
                            <li class="pe-2 ps-5">
                                <a href="{{ route('bootcamps') }}"
                                    class="@if ($current_route == 'bootcamps' || $current_route == 'bootcamp.details') active @endif">
                                    {{ get_phrase('Bootcamp') }}
                                </a>
                            </li>
                            ...
                            <!-- More Mega Menu -->
                            <li class="have-mega-menu">
                                <a href="{{ route('courses') }}" class="menu-parent-a">
                                    {{ get_phrase('More') }}
                                </a>
                                <ul class="mega-dropdown-menu mega main-mega-menu">
                                    <div class="mega-menu-items">
            ...
            <div class="col-auto">
                <div class="primary-end d-flex align-items-center">
                    <div class="d-flex align-items-center gap-2 me-4 ms-4">
                        ...
                        @endisset
                        <!-- أيقونة البحث -->
                        <a href="javascript:void(0);" class="position-relative  me-4 ms-4" data-bs-toggle="modal"
                            data-bs-target="#searchModal" data-bs-toggle="tooltip"
                            data-bs-title="{{ get_phrase('Search') }}" data-bs-placement="bottom">
                            <span class="search-top-number d-none">
                                <!-- هنا يمكن وضع عدد النتائج أو البحث الحالي إذا أردت -->
                                0
                            </span>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <circle cx="11" cy="11" r="8" stroke="#192335" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <line x1="16" y1="16" x2="21" y2="21" stroke="#192335"
                                ...
                                @if (!in_array(auth()->user()->role, ['admin', 'instructor']))
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('support.ticket.index') }}">
                                            <svg width="21" height="21" viewBox="0 0 24 24" fill="#6B7385"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                    ...
                    @else
                        <a href="{{ route('register.formm', ['type' => 'instructor']) }}"
                            class="d-none d-lg-inline-block eBtn btn gradient m-1">{{ get_phrase('Register as Instructor') }}</a>
                        <a href="{{ route('register.formm', ['type' => 'student']) }}"
                            class="d-none d-lg-inline-block eBtn btn gradient m-1">{{ get_phrase('Register as Student') }}</a>
            ...
            <div class="offcanvas-body px-4">
                <div class="off-menu">
                        ...
                        <ul class="list-unstyled ps-0">
                            @auth
                                <li>
                                    <div class="d-flex align-items-center my-4 mt-5">
                                        ...
                                        <a data-bs-toggle="tooltip" title="{{ get_phrase('Logout') }}"
                                            class="btn btn-light text-14px me-3 ms-auto logout-link" href="javascript:;">
                                            <i class="fi-rr-arrow-right-to-bracket"></i> </a>
                                    </div>
                                </li>
                                @if ((auth()->user() && auth()->user()->role == 'student') || (auth()->user() && auth()->user()->role == 'instructor'))
                                    ...
                                    {{-- ebook start --}}
                                    <li>
                                        <a class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3"
                                            href="{{ route('my.ebooks') }}"> {{ get_phrase('My Ebooks') }}
                                        </a>
                                    </li>
                                    {{-- ebook end --}}
                            ...
                            <li><a class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3"
                                    href="{{ route('ebooks') }}"
                                    class="@if ($current_route == 'ebooks' || $current_route == 'ebook.details') active @endif">{{ get_phrase('Ebooks') }}</a>
                            </li>
                            <li><a href="{{ route('course.bundles') }}"
                                    class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3">{{ get_phrase('Course Bundle') }}</a>
                            </li>
                    ...
                    @guest
                        <div class="btn-off">
                            <a href="{{ route('register.formm', ['type' => 'instructor']) }}"
                                class="eBtn btn gradient mb-3">{{ get_phrase('Register as Instructor') }}</a>
                            <a href="{{ route('register.formm', ['type' => 'student']) }}"
                                class="eBtn btn gradient sign">{{ get_phrase('Register as Student') }}</a>
                        </div>
                    @endguest
                </div>
            </div>
